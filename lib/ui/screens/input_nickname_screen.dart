...
import 'package:chess_io/ui/screens/learn_chess_screen.dart';
            ...
            Align(
              ...
              child: Row(
                ...
                children: [
                  ...
                  GestureDetector(
                    onTap: () => Navigator.of(context).push(CustomPageTransition(page: LearnChessScreen(), transitionType: PageTransitions.SCALE)),
                    child: Container(
                      decoration: BoxDecoration(
                          color: theme.primaryColor,
                          shape: BoxShape.circle
