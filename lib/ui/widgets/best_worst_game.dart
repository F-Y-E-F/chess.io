...
import 'package:chess_io/ui/screens/game_details_screen.dart';
...
class BestWorstGame extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return  Column(
      children: [
        if(bestGame!=null)  _cardGameItem(bestGame, "Best win",context),
        if(worstGame!=null) _cardGameItem(worstGame, "Worst loss",context),
      ],
    );
  }

  Widget _cardGameItem(Game game, String title,BuildContext context) => GestureDetector(
    onTap: () => Navigator.of(context).push(CustomPageTransition(page: GameDetailsScreen(game.time),transitionType: PageTransitions.SCALE)),
    child: Container(
